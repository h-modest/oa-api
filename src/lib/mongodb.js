...
import pomolo from 'pomelo-logger';
let logger = pomolo.getLogger('mongodb-log');
...
if (options.db_user && options.db_pwd) {
  dbURL+= options.db_user + ":" + options.db_pwd + "@";
}
dbURL+=options.db_host + ":" + options.db_port + "/" + options.db_name;

//fixed error: Mongoose: mpromise (mongoose's default promise library) is deprecated, plug in your own promise library instead: http://mongoosejs.com/docs/promises.html
